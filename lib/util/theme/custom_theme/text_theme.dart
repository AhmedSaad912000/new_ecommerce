...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 16.0,fontWeight: FontWeight.w400,color: Colors.black.withOpacity(0.5)),
    // label
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 16.0,fontWeight: FontWeight.w400,color: Colors.white.withOpacity(0.5)),
    // label
